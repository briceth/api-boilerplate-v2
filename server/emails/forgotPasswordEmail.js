                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
                                                        ...
                                                        <p class="hero">Vous avez oublié votre mot de passe ?</p>
                                                        <p>Cliquez sur le bouton en dessous pour définir un nouveau mot de passe.</p>
                                                        <p>
                                                          <a href="${url}/auth/nouveau-mot-de-passe?token=${
      user.passwordChange.token
    }${
      user.account.picture ? `&picture=${user.account.picture}` : ''
    }" class="btn" mc:disable-tracking="">Nouveau mot de passe</a>
                                                        </p>
